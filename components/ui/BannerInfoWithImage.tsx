...
export function BannerInfoWithImage({ isMobile }: PropsBannerInfoWithImage) {
  ...
  const desktopSrc = 'https://assets.decocache.com/true-source/514c17e5-4310-4b60-8b34-9225d57dfc3b/banner-topo-profissional-de-saude-min.png';
      ...
      <section className="bg-white">
        <div className="w-full relative rounded-b-[20px] lg:rounded-b-[77px] overflow-hidden">
          ...
          <div className="absolute left-0 top-0 w-full h-full flex flex-col items-center justify-center px-9 lg:px-0">
            <h3 className="font-lemon-milk text-[12px] lg:text-[24px] leading-none font-bold text-center uppercase fontWithGradient py-1 mb-4 lg:mb-11">
              magnésio + inositol relief 3.0
            </h3>

            <h2 className="max-w-[758.05px] font-lemon-milk text-[24px] lg:text-[40px] leading-none lg:leading-[107%] font-bold text-center uppercase text-ice mb-5 lg:mb-9">
              Validado pela ciência para transformar a qualidade do sono e o 
