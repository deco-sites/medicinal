...
export default function CTAFixoCustom() {
	...
	return (
		<div
			...
			className={`fixed bottom-0 w-full h-[85px] flex items-center justify-center rounded-t-[28px] bg-white z-50 ${
		...
		>
			...
			>
				<div className='w-full max-w-[207px] lg:max-w-[270px] relative'>
					<button
						type='button'
						className={`w-full h-[38px] lg:h-[56px] flex items-center justify-center gap-4 bg-[#B6B6B6] rounded-[28px] relative z-10 ${
							isOptionsVisible ? 'border-t border-solid border-white' : ''
						}`}
						onClick={handleSelectedOption}
					>
						<span className=' text-[10px] lg:text-[13px] font-bold leading-none uppercase text-white max-w-[150px] lg:max-w-[200px] line-clamp-1'>
					...
					<div
						className={`flex flex-col gap-3 absolute bottom-[56px] left-0 w-full bg-[#B6B6B6] px-4 py-6 rounded-t-[28px] -mb-4 lg:-mb-6 lg:pb-9 ${
