...
export default function Stories({
	...
	return (
		<div className='mb-20 max-w-[1340px] mx-auto'>
			<h2 className=' max-w-[290px] lg:max-w-full mx-auto text-[18px] lg:text-[24px] leading-[104%] text-center font-bold uppercase text-[#1e1e1e] mb-9 lg:mb-20'>
				{children}
			</h2>
									...
									<>
										...
										{video?.user && (
											<div className='absolute left-7 bottom-8 z-20 flex flex-col gap-3'>
												<span className=' text-[14px] lg:text-[16px] leading-[1.6] uppercase font-bold text-white'>
													{video.user.name}
												</span>
