...
function PageMagnesioCustomerFinish({ isMobile }: Props) {
	return (
		<div className='min-w-[375px] mb-[75px] lg:mb-[192px]'>
			...
			<AboutGrid
				...
				title={() => (
					<>
						conheça a
						<br />
						<span className='fontWithGradient'>fórmula perfeita</span>
					</>
				)}
			/>
					...
					testimonials={[
						{
							...
							text:
								'Depois de começar a usar o True Magnésio, minhas noites de sono nunca mais foram as mesmas. Agora, acordo revigorada e com energia de sobra para encarar todos os desafios do dia!',
						...
						},
						{
							...
							text:
								'Além de finalmente conseguir ter uma boa noite de sono, percebi uma grande melhora na minha disposição e na minha saúde como um todo. Recomendo para todas as mulheres que querem uma vida melhor!',
						...
						},
						{
							...
							text:
								'Sempre tive dificuldades para relaxar à noite, mas com o True Magnésio, consigo relaxar com mais facilidade e acordo me sentindo mais descansada. Sem contar que meu humor e minha concentração melhoraram muito!',
						...
						},
						{
							...
							text:
								'Eu costumava acordar várias vezes durante a noite, mas desde que comecei a usar o True Magnésio, meu sono tem sido profundo e ininterrupto. Sinto-me muito mais equilibrada e com mais vitalidade ao longo do dia.',
						...
						},
						{
							...
							text:
								'O True Magnésio Inositol Relief 3.0 realmente fez a diferença para mim. Notei não apenas uma melhoria no sono, mas também uma redução significativa no estresse e na ansiedade. Sinto-me mais calma e centrada.',
			...
			>
				<>
					Veja os depoimentos de quem usa ou <br className='hidden lg:block' />
					prescreve{' '}
