...
function CardsWithCta({ title, cta, cards, description }: Props) {
	...
	return (
		<div id={id} class='flex flex-col items-center py-16'>
			...
			<div class='flex flex-col items-center gap-6 mt-8 md:mt-14 w-full'>
				<Slider className='carousel gap-4 max-w-full'>
					{cards?.map((card, index) => (
						<Slider.Item
							index={index}
							className='carousel-item group flex items-center justify-center first:pl-5 last:pr-5'
						>
