			...
			<div style='background: linear-gradient(125deg, rgba(234, 198, 240, .6) 10%, rgba(253, 227, 206, 1) 100%);'>
				<div className='pt-10 lg:pt-14 lg:flex lg:justify-between max-w-[1060px] mx-auto'>
					<div className='flex flex-col items-center lg:items-start mb-9 lg:mb-0 lg:min-w-[400px] lg:pt-14'>
						<h2 className=' text-[32px] lg:text-[40px] leading-[104%] font-bold text-center lg:text-left uppercase mb-9 lg:mb-11 fontWithGradient'>
							o SEGREDO PARA
							<br />
							NOITES DE SONO
							<br />
						...
						<a
							href='#cupom'
							className='flex items-center gap-[10px] uppercase  font-bold text-[13px] leading-[17px] text-ice py-[15px] px-6 rounded-full max-w-fit group border border-red hover:border-transparent cursor-pointer max-h-[40px]'
						>
			...
			<div className='rounded-t-[28px] lg:rounded-t-[70px] pt-[114px] lg:pt-[100px] -mt-[78px] lg:-mt-[170px] bg-white mb-10 lg:mb-24'>
				<div className='max-w-[1060px] mx-auto'>
					<div className='max-w-[344px] lg:max-w-full mx-auto pb-10 lg:pb-24'>
						...
						<br />
						<p className='text-[14px] lg:text-[18px] leading-[160%] font-medium text-[#1e1e1e] text-center lg:text-left'>
							Com o tempo, noites mal dormidas se tornam frequentes, afetando humor, produtividade e
							bem-estar. Com o{' '}
							<strong className='font-black'>
								Magnésio + Inositol Relief 3.0
							</strong>
							, você encontra uma solução que não só te ajuda a dormir melhor, mas também contribui para a
							saúde dos ossos, músculos, coração e intestinos.
						</p>
					</div>
					...
					<div className='flex flex-col justify-center items-center gap-11 px-6 lg:px-0 mb-14 lg:mb-28 lg:relative'>
						...
						<h3 className=' text-[18px] lg:text-[24px] leading-none text-center font-bold uppercase py-1 lg:text-dark lg:absolute !bg-transparent'>
					...
					<ul className='px-12 lg:grid lg:grid-cols-3 lg:gap-16'>
						<li className='flex lg:flex-col gap-8 pb-8 lg:pb-0 border-b lg:border-b-0 lg:border-l border-solid border-[#D2D2D2] lg:pl-10'>
							...
							<p className='text-[14px] leading-[160%] font-500 text-[#1e1e1e] flex-1'>
								<strong>Um sono profundo e restaurador:</strong>{' '}
								Sua fórmula de alta absorção com magnésio bisglicinato promove relaxamento e melhora a
								qualidade do sono.
							</p>
						</li>
						...
						<li className='flex lg:flex-col gap-8 py-8 lg:py-0 border-b lg:border-b-0 lg:border-l border-solid border-[#D2D2D2] lg:pl-10'>
							...
							<p className='text-[14px] leading-[160%] font-500 text-[#1e1e1e] flex-1'>
								<strong>Uma vida mais equilibrada e saudável:</strong>{' '}
								Ativos que auxiliam na saúde do coração, do sistema digestivo e nervoso.
							</p>
						</li>
						...
						<li className='flex lg:flex-col gap-8 py-8 lg:py-0 border-b lg:border-b-0 lg:border-l border-solid border-[#D2D2D2] lg:pl-10'>
							...
							<p className='text-[14px] leading-[160%] font-500 text-[#1e1e1e] flex-1'>
								<strong>Fórmula Limpa:</strong>{' '}
								Livre de aditivos e corantes artificiais, glúten, lactose e açúcar, garantindo uma opção
