...
export function AboutGrid2({ isMobile }: PropsAboutGrid2) {
	return (
		<div className='max-w-[1135px] mx-auto mb-12 lg:mb-16 px-5 lg:px-0'>
			<h2 className=' text-[18px] lg:text-[24px] leading-[104%] text-center uppercase font-bold mb-11 lg:mb-16'>
			...
			<ul className='grid grid-cols-1 lg:grid-cols-2 gap-1.5 lg:gap-7 mb-12'>
				<li class='flex items-center relative rounded-[23px] overflow-hidden'>
					...
					<div className='absolute px-6 lg:px-12 w-full'>
						<h4 className='w-full  text-[20px] leading-none font-bold uppercase text-white'>
							maracujá
						</h4>
					</div>
				</li>
				...
				<li class='flex items-center relative rounded-[23px] overflow-hidden'>
					...
					/>
					<div className='absolute px-6 lg:px-12 w-full'>
						<h4 className='w-full  text-[20px] leading-tight font-bold uppercase text-white text-right'>
							camomila
							<br />
			...
			<div className='max-w-[826px] mx-auto'>
				<div className='flex lg:items-center gap-6 lg:gap-8 pb-[60px] border-b border-solid border-[#D2D2D2] px-3 lg:px-0'>
					...
					<p className='text-[14px] leading-[1.6 ] font-medium text-[#1e1e1e]'>
						<strong>Fácil de preparar!</strong>{' '}
						Misture 1 medida dosadora em 150ml de água. Consumir próximo ao horário de dormir. Também pode
						ser adicionado a receitas como picolés, sucos, shakes e outras bebidas de sua preferência.
					</p>
				</div>
			</div>
		</div>
