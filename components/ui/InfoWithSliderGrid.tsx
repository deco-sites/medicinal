...
export function InfoWithSliderGrid() {
	return (
		<section
			id='info-with-slider-grid'
			className='py-10 lg:py-20 mx-auto max-w-[1340px] mb-12 lg:mb-24'
		>
			<div className='flex flex-col items-center mb-8'>
				...
				<h2 className='max-w-[326px] md:max-w-[620px]  text-[16px] lg:text-[24px] leading-tight font-bold uppercase text-center'>
					em parceria com
			...
			<div id='slider' className='mb-20'>
				...
				>
					...
					>
						...
						>
							<span className='w-fit p-[10px] bg-white rounded-xl  text-[18px] leading-none font-bold text-center text-[#E9530E]'>
								42%
							</span>
			...
			<p className='text-[14px] lg:text-[18px] leading-[1.7] font-medium text-center text-dark px-[42px] mb-10 lg:mb-[76px]'>
				...
				<strong>Índice de Pittsburgh</strong>,
			...
			<div className='relative rounded-[35px] overflow-hidden'>
				...
				<div className='absolute top-12 w-full px-12 lg:top-[86px] lg:left-32 lg:max-w-[400px] lg:px-0'>
					<h3 className=' text-[16px] lg:text-[24px] leading-tight uppercase font-bold text-white mb-6'>
					...
					<ul>
						...
						<li className='text-[14px] lg:text-[18px] leading-[1.6] font-medium text-white lg:text-[#1e1e1e]'>
							<strong className='font-black'>20%</strong>{' '}
							sentiram que o corpo físico deixou de ser uma limitação;
							<br />
							<br />
						</li>
						<li className='text-[14px] lg:text-[18px] leading-[1.6] font-medium text-white lg:text-[#1e1e1e]'>
