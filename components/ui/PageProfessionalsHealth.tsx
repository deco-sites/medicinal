        ...
        videos={[
          {
            ...
            thumbs: 'https://assets.decocache.com/true-source/b44c59db-0ca9-493b-9839-5433f5130d6f/thumb_video_01.jpg',
            user: {
          ...
          },
          {
            ...
            thumbs: 'https://assets.decocache.com/true-source/4d5372ce-4be0-4942-b18a-c3ecf883e75f/thumb_video_02.jpg',
            user: {
              name: 'Dr. Victor Sorrentino',
              profession: 'Médico, Escritor e Professor',
              instagram: '@drvictorsorrentino'
          ...
          },
          {
            ...
            thumbs: 'https://assets.decocache.com/true-source/0788b7ab-6ce1-4eb6-b11e-9f0d6b9d6398/thumb_video_03.jpg',
            user: {
              name: 'Dr. Victor Sorrentino',
              profession: 'Médico, Escritor e Professor',
              instagram: '@drvictorsorrentino'
          ...
          },
          {
            ...
            thumbs: 'https://assets.decocache.com/true-source/9646d291-767d-4d9c-8f87-c0f709a34903/thumb_video_04.jpg',
            user: {
              name: 'Dr. Victor Sorrentino',
              profession: 'Médico, Escritor e Professor',
              instagram: '@drvictorsorrentino'
