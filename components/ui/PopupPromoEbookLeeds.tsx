...
export default function () {
  ...
  function formatPhone(event: React.ChangeEvent<HTMLInputElement>) {
    ...
    let text: RegExpMatchArray | null = value
      .replace(/\D/g, "")
  ...
  async function handleSubmit(event: Event) {
    ...
    setLoading(true);
    await fetch('https://jobs.truesource.com.br/insider/upsert', {
      method: 'POST',
      headers: {
      ...
      globalThis.open('https://truue.link/ebook-receitas-saudaveis', '_blank');
  ...
  return (
    <div className={`${!showPopup ? 'hidden' : ''} fixed top-0 bottom-0 left-0 right-0 z-[9999999999999] bg-[#000] bg-opacity-85 flex items-center	justify-center`}>
      <div className="w-full max-w-[342px] sm:max-w-[500px] bg-white rounded-[20px] overflow-hidden">
        <Image
          src="https://tfcucl.vtexassets.com/assets/vtex.file-manager-graphql/images/2de3d705-f115-4ac2-b985-aee355e7d389___4a3bd5c0a934e9643c414ef44b539414.jpg"
          alt="Banner receitas True Source"
          width={500}
        />
