...
function PromoCoupon({ isMobile, coupon }: PropsPromoCoupon) {
  ...
  return (
    <div id="cupom">
      <h2 className="font-lemon-milk text-[24px] leading-tight text-center font-bold text-dark mb-4 lg:mb-20">
        transforme sua <br />
        rotina agora
      </h2>
      ...
      >
        ...
        <div className="absolute w-full lg:w-fit pt-[77px] lg:pt-0 lg:pl-[120px] flex flex-col gap-3.5 lg:gap-8 z-10">
          <h2 className="font-lemon-milk text-[24px] lg:text-[40px] font-bold leading-tight text-center lg:text-left text-[#3C3C3B]">
            ganhe {" "}
            <span className="fontWithGradient">15%OFF e <br /> mini copo térmico</span><br /> 
            na compra de duas
            <br />
            unidades de{" "}
            <span className="fontWithGradient">magnésio <br /> + inositol relief 3.0</span>
          </h2>
          ...
          <div className="flex flex-col items-center justify-center gap-5 lg:gap-7 lg:justify-start">
            <div className="flex flex-col items-center justify-center gap-3 lg:flex-row lg:gap-5 lg:justify-start">
              ...
              <span className="font-lemon-milk fontWithGradient text-[24px] leading-none font-bold text-center border-2 border-dashed border-black rounded-xl flex items-center justify-center  w-[256px] lg:w-[243px] h-[63px]">
                {coupon}
              </span>
            ...
            <form onSubmit={addProductToCart} className="w-full flex flex-col lg:flex-row px-8 lg:px-0 items-center gap-3 lg:gap-5">
              <div className="w-full relative">
                <button
                  type="button"
                  className={`w-full h-[47px] lh:h-[63px] flex items-center justify-center gap-4 bg-[#B6B6B6] rounded-[28px] relative z-10 ${isOptionsVisible ? 'border-t border-solid border-white' : ''}`}
                  onClick={handleSelectedOption}
                >
                  <span className="font-lemon-milk text-[10px] lg:text-[13px] font-bold leading-none uppercase text-white line-clamp-1">
                ...
                <div className={`flex flex-col gap-3 absolute bottom-[56px] left-0 w-full bg-[#B6B6B6] px-4 pt-6 pb-10 rounded-t-[28px] -mb-8 ${!isOptionsVisible ? 'hidden': ''}`}>
