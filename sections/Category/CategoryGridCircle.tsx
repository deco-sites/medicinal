    ...
    <>
      ...
      <div className='py-12 mx-auto w-full max-w-[1440px]'>
        ...
        <ul className='grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8 px-8 lg:px-0 lg:max-w-[70%] lg:mx-auto'>
          <li>
            <a href="https://www.truesource.com.br/carnavaltrue/classic" class='flex flex-col items-center gap-4'>
              <figure>
                <Image
                  class='w-full'
          ...
          <li>
            <a href="https://www.truesource.com.br/carnavaltrue/plus" class='flex flex-col items-center gap-4'>
              <figure>
                <Image
                  class='w-full'
          ...
          <li>
            <a href="https://www.truesource.com.br/carnavaltrue/premium" class='flex flex-col items-center gap-4'>
              <figure>
                <Image
                  class='w-full'
          ...
          <li>
            <a href="https://www.truesource.com.br/carnavaltrue/exclusive" class='flex flex-col items-center gap-4'>
              <figure>
                <Image
                  class='w-full'
