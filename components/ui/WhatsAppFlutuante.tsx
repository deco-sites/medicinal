...
function WhatsAppFlutuante({ ...props }: SectionProps<ReturnType<typeof loader>> & WhatsAppFlutuanteProps) {
    const date = new Date();
    ...
    if (hours === endHour && minutes > endMinute)
        return null;
    return (<a href={props.url} target={"_blank"} class="flex items-center w-[64px] h-[64px] fixed rounded-full justify-center bottom-[25px] right-[25px] bg-[#25d366] z-[51]">
